...
Rabbit R1，这款售价199美元的橙色长方体设备，标榜自身为“超级智能、极其便捷的AI助手”。它承诺超越ChatGPT的对话能力，还能更高效地完成手机上的各种任务。然而，实际测试却暴露了其诸多缺陷，让人不禁怀疑其是否具备基本的实用性。

## **LAM：雄心勃勃的技术，未兑现的承诺**

R1的核心技术是Rabbit所谓的“大型动作模型”（LAM）。与擅长文本分析和生成的大型语言模型（LLM）不同，LAM专注于“做事”，通过学习应用程序的运作方式来代替用户操作。想象一下，只需说一句“把背景中的那个女士去掉”就能使用Photoshop，或者让设备自动从网站获取数据生成表格，这正是LAM所描绘的未来图景。

遗憾的是，LAM目前仅支持Uber、DoorDash、Midjourney和Spotify四个应用程序，且连接方式繁琐。用户需在Rabbithole网络应用程序中逐一登录，Rabbit则通过虚拟浏览器“窥探”整个过程，引发安全和隐私担忧。更令人失望的是，除了Midjourney外，其他应用程序都无法正常使用。无论是订餐、打车还是播放音乐，R1的响应要么是漫长的等待，要么是令人啼笑皆非的错误。

## **Spotify集成：笨拙且令人沮丧**

作为R1主打的集成功能之一，Spotify的体验却让人失望。播放指令经常出错，例如将“Discover Weekly”播放列表误识别为歌曲，或将播客与电影原声带混淆。更常见的情况是，R1毫无反应，只是弹出一个欢快的确认信息后便陷入沉默。

## **信息查询：表现平平，错误频出**

对于基本的琐事和信息查询，R1的表现与其他AI设备类似，时而正确，时而错误，速度也不稳定。尽管它能提供实时信息，例如新闻和体育比分，但准确性仍有待提高。

## **亮点：语音记录器和视觉识别**

R1并非一无是处。其内置的语音记录器功能表现出色，能够记录音频并进行AI总结。此外，在识别地标建筑等常见物体时，其视觉功能也展现了不错的准确性。

## **设计与功能：美观与实用**

抛开AI功能不谈，R1的硬件设计和功能组合值得肯定。它拥有舒适的手感、醒目的外观、方便的按钮设计以及屏幕/扬声器组合，还配备了一个有趣的滚轮。

## **AI硬件的未来：手机的竞争与新交互方式的探索**

R1的失败引发了关于AI硬件未来发展的思考。相比Humane AI Pin等可穿戴设备，R1更像是功能受限的智能手机，难以摆脱手机的竞争。未来，我们可能会看到更多与手机协同工作的AI设备，例如带有增强麦克风的耳机或支持ChatGPT输出的智能手表，而Meta智能眼镜等扩展手机功能的设备也值得期待。

### **结论：AI硬件革命尚未到来**

R1的糟糕体验表明，AI硬件革命尚未到来。在硬件、软件和AI技术取得突破性进展之前，智能手机仍将是我们的主要设备。Rabbit R1的失败是一个警示，提醒我们AI硬件的发展之路还很漫长。

**改进建议：**

* 专注于LAM技术的完善，使其支持更多应用程序并提升可靠性。

* 优化Spotify等集成功能，确保指令准确执行。

* 提高信息查询的准确性和响应速度。

* 探索与手机协同工作的可能性，而非试图取代手机。

* 降低价格，使其更具吸引力。

**Rabbit R1是一款充满雄心壮志却未能兑现承诺的AI设备。它提醒我们，AI硬件的发展需要脚踏实地，专注于解决实际问题，而非过分追求概念和噱头。**



Rabbit R1 这款售价 199 美元的橙色长方形设备，被吹捧为超级智能、极其方便的 AI 助手。它不仅能像 ChatGPT 一样回答问题，还能完成手机上的各种任务，而且速度更快。然而，在我对 R1 的测试中，我遇到了很多“玉米片变玉米卷”的情况，整个设备的表现让人感觉它根本无法正常工作。
...
然而，几乎没有证据表明 LAM 实际有效。该设备目前只能连接到四个应用程序：Uber、DoorDash、Midjourney 和 Spotify。连接方式是打开 Rabbit 的网络应用程序 Rabbithole，并分别登录每个服务。当你这样做时，Rabbit 会在应用程序内部打开一个虚拟浏览器，让你直接登录，而不是登录 DoorDash 提供的服务，而是直接登录 DoorDash 的网站，而 Rabbit 则会窥探整个过程。Rabbit 表示它会保护你的凭证，但这个过程让人感觉很不舒服，而且不安全。
...
总之，R1 所有最酷、最雄心勃勃、最有趣和最与众不同的功能都无法正常工作，甚至根本不存在。当我第一次在 CES 上看到该设备的演示时，创始人兼首席执行官 Jesse Lyu 将他的 R1 无法完成他刚刚说的大部分事情归咎于 Wi-Fi。现在我想 Wi-Fi 可能没有问题。
